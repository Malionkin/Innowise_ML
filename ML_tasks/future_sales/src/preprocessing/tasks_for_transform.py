...
def transform_items(items,train):
...
def create_train(train,items,shops,cats):
    train = (
    ...
    return train
def create_test(test,items,shops,cats):
    test = (
...
def create_train_monthly(train,test):
...
def transform_train_monthly(train_monthly):
...
def creating_lag_features(train_monthly): 
    ...
    return train_monthly
def add_trends(train_monthly,train):
